...
import useUser from "@/features/details/hooks/useUser";
import useChangePassword from "@/features/details/hooks/useChangePassword";
...
export default function Details() {
  ...
  return (
    <div className="p-8 max-w-md mx-auto bg-white dark:bg-gray-800 mt-[5%] rounded">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        ...
        <Button type="submit" disabled={changePasswordMutation.isLoading} className="mt-2">
          {changePasswordMutation.isLoading ? t("loading_saving") : t("btn_change_password")}
        </Button>
      </form>
    </div>
  );
